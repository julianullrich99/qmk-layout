...
rgb_matrix_disable();
    ...
    const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT(QK_BOOTLOADER, RGB_MODE_RAINBOW, RGB_TOG, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, LSFT_T(KC_A), RGB_MODE_PLAIN, LT(1, KC_D), LT(3, KC_F), KC_G, KC_H, LT(4, KC_J), LT(2, KC_K), LT(6, KC_L), LSFT_T(KC_SCLN), KC_Z, LCTL_T(KC_X), LALT_T(KC_C), KC_V, KC_B, KC_N, KC_M, LALT_T(KC_COMM), LCTL_T(KC_DOT), KC_SLSH, KC_P0, KC_BSPC, LT(7, KC_SPC), KC_P1),
